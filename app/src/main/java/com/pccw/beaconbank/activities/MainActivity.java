...
import com.pccw.beaconbank.fragments.AccountFragment;
...
public class MainActivity extends AppCompatActivity implements TabLayout.OnTabSelectedListener {
    ...
    private void setUpTabLayout(TabLayout tabLayout) {
        setTitle("Home");
        tabLayout.getTabAt(0).setIcon(R.drawable.home).getIcon().setColorFilter(Color.WHITE, PorterDuff.Mode.SRC_IN);
        tabLayout.getTabAt(1).setIcon(R.drawable.view_list);
